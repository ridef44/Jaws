        ...
        <div class="panel-footer" align="center">
                <div class="user-box">
                    ...
                    <div class="wrap">
                        ...
                        <div class="text_over_image" id="textToEdit">Editar <span class="glyphicon glyphicon-pencil" ></div>
                    </div>
    ...
    <div class="panel-heading">Menú <span class="glyphicon glyphicon-th-list" ></div>
    <div class="panel-body">
        <ul class="nav nav-pills nav-stacked">
            @if (auth()->check())
                <li @if(request()->is('home')) class="active" @endif>
                    <a href="/home">Dashboard <span class="glyphicon glyphicon-stats" ></a>
                </li>

                {{-- @if (! auth()->user()->is_client) --}}
                {{-- <li @if(request()->is('ver')) class="active" @endif> --}}
                {{-- <a href="/ver">Ver Caso <span class="glyphicon glyphicon-zoom-in" ></a> --}}
                {{-- </li> --}}
                {{-- @endif --}}

                <li @if(request()->is('reportar')) class="active" @endif>
                    <a href="/reportar">Reportar Caso <span class="glyphicon glyphicon-zoom-in" ></a>
                </li>
                ...
                <li role="presentation" class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="/usuarios">Usuarios <span class="glyphicon glyphicon-user" ></a></li>
                        <li><a href="/proyectos">Proyectos <span class="glyphicon glyphicon-calendar" ></a></li>
                        <li><a href="/config">Configuración <span class="glyphicon glyphicon-cog" ></a></li>
                    </ul>
                </li>
                @endif
            @else
